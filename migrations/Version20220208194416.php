 ...
 */
final class Version20220208194416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurateur CHANGE res_adresse res_adresse VARCHAR(255) DEFAULT NULL');
