 ...
 */
final class Version20220210123542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD fk_restaurant_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6EEAA67DD5AD05AC ON commande (fk_restaurant_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6EEAA67DD5AD05AC ON commande');
        $this->addSql('ALTER TABLE commande DROP fk_restaurant_id, CHANGE co_adresse_de_livraison co_adresse_de_livraison VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE horaire_restaurant CHANGE horaire_debut_midi horaire_debut_midi VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE horaire_fin_midi horaire_fin_midi VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE horaire_debut_soir horaire_debut_soir VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE horaire_fin_soir horaire_fin_soir VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
