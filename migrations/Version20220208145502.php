 ...
 */
final class Version20220208145502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE cl_nom cl_nom VARCHAR(255) DEFAULT NULL, CHANGE cl_prenom cl_prenom VARCHAR(255) DEFAULT NULL, CHANGE cl_telephone cl_telephone INT DEFAULT NULL, CHANGE cl_adresse cl_adresse VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE livreur CHANGE li_nom li_nom VARCHAR(255) DEFAULT NULL, CHANGE li_prenom li_prenom VARCHAR(255) DEFAULT NULL, CHANGE li_telephone li_telephone INT DEFAULT NULL');
        $this->addSql('ALTER TABLE restaurateur CHANGE res_nom res_nom VARCHAR(255) DEFAULT NULL, CHANGE res_prenom res_prenom VARCHAR(255) DEFAULT NULL, CHANGE res_telephone res_telephone INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livreur CHANGE li_nom li_nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE li_prenom li_prenom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE li_telephone li_telephone INT NOT NULL, CHANGE li_mail li_mail VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
