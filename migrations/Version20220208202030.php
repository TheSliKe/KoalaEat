 ...
 */
final class Version20220208202030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, fk_li_id INT DEFAULT NULL, fk_cl_id INT NOT NULL, co_adresse_de_livraison VARCHAR(255) NOT NULL, INDEX IDX_6EEAA67D8423EA8F (fk_li_id), INDEX IDX_6EEAA67D31AD8D6C (fk_cl_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE horaire_restaurant (id INT AUTO_INCREMENT NOT NULL, fk_re_id INT NOT NULL, fk_sem_id INT DEFAULT NULL, horaire_debut_midi TIME DEFAULT NULL, horaire_fin_midi TIME DEFAULT NULL, horaire_debut_soir TIME DEFAULT NULL, horaire_fin_soir TIME DEFAULT NULL, INDEX IDX_2A6E34AE11257CD4 (fk_re_id), INDEX IDX_2A6E34AE1D447D9D (fk_sem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
